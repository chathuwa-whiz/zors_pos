        ...
        return (
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
                {products.map((product) => {
                    ...
                    return (
                        <div key={product._id} className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-lg transition-shadow">
                            {/* Product Image */}
                        ...
                        {products.map((product, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="px-6 py-4">
                                        <span className={`font-medium ${stockStatus.status === 'out' ? 'text-red-600' : 'text-gray-900'}`}>
                                            {product.stock}
                                        </span>
                                    </td>
                                    <td className="px-6 py-4">
