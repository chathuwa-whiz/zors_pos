...
import { Lock, Eye, EyeOff, Shield, CheckCircle, AlertCircle, Key, ArrowLeft, Receipt } from 'lucide-react';
import { motion, AnimatePresence } from 'framer-motion';
import { User } from '@/app/types/user';
import OrderCompleteCustomize from './orderCompleteCustomize';
...
export default function SettingsPage() {
  ...
  const [activeTab, setActiveTab] = useState<'password' | 'receipt'>('password');
    ...
    <div className="min-h-screen bg-gradient-to-br from-green-50 via-lime-50 to-green-100">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-green-700 text-lg">Manage your account and preferences</p>
          {user && (
        ...
        >
          <button
            ...
            className={`flex-1 py-3 px-6 rounded-xl font-semibold transition-all duration-200 flex items-center justify-center space-x-2 ${
              activeTab === 'password'
                ? 'bg-gradient-to-r from-green-900 to-green-800 text-white shadow-lg'
          ...
          {activeTab === 'password' ? (
            ...
            >
              ...
              <AnimatePresence>
                {message && (
                  <motion.div
                    className={`mx-6 mt-6 p-4 rounded-xl border-2 ${
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className={`w-full pl-12 pr-14 py-4 text-lg border-2 rounded-xl focus:ring-4 focus:ring-lime-400/30 transition-all duration-200 bg-white ${
                ...
                <div className="pt-4">
                  <motion.button
                    ...
                    className={`w-full py-4 rounded-xl font-bold text-xl transition-all duration-200 flex items-center justify-center space-x-3 ${
                      loading || !isFormValid
            ...
            >
              <div className="bg-gradient-to-r from-green-900 to-green-800 p-6 text-center relative overflow-hidden">
                ...
                <div className="relative z-10 flex items-center justify-center space-x-3">
                  ...
                  <h2 className="text-xl font-bold text-white">Bill Template</h2>
                </div>
                <p className="text-green-100 mt-2">Customize your order bill appearance</p>
              </div>

              <div className="p-6">
                <OrderCompleteCustomize />
              </div>
            </motion.div>
          )}
        </AnimatePresence>
